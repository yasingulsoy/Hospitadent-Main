    ...
    submenu: [
      {
        ...
        path: '',
        submenu: [
          { name: 'Mecidiyeköy', path: 'mecidiyekoy' },
          { name: 'Bağcılar', path: 'bagcilar' },
          { name: 'Bakırköy', path: 'bakirkoy' },
          { name: 'Fatih', path: 'fatih' },
          { name: 'Çamlıca', path: 'camlica' },
          { name: 'Pendik', path: 'pendik' },
          { name: 'Şerifali', path: 'serifali' },
          { name: 'Cevizlibağ', path: 'cevizlibag' },
          { name: 'Göktürk', path: 'gokturk' },
        ]
      },
      { name: 'Kayseri', path: 'kayseri' },
      { name: 'Bodrum', path: 'bodrum' },
      { name: 'Alanya', path: 'alanya' },
      { name: 'Antalya', path: 'antalya' },
      { name: 'Ankara', path: 'ankara' },
      { name: 'Denizli', path: 'denizli' },
      { name: 'Kocaeli', path: 'kocaeli' },
      { name: 'Bursa', path: 'bursa' },
      { name: 'Almanya', path: 'almanya' },
      { name: 'Hollanda', path: 'hollanda' },
    ]
  },
  {
    name: 'Tedavilerimiz',
