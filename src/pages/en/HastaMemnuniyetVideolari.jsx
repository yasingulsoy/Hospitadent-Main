...
const HastaMemnuniyetVideolari = () => {
  ...
  const videos = [
    {
      id: 1,
      title: 'Patient Satisfaction Video 1',
      description: 'A satisfied patient shares their experience with our dental treatment.',
      videoUrl: '/assets/videos/firat_okur.mp4',
      thumbnail: '/assets/pic-1.png'
    },
    {
      id: 2,
      title: 'Patient Satisfaction Video 2',
      description: 'Another patient testimonial about our professional dental services.',
      videoUrl: '/assets/videos/firat_okur.mp4',
      thumbnail: '/assets/pic-2.png'
    },
    {
      id: 3,
      title: 'Patient Satisfaction Video 3',
      description: 'Patient satisfaction and quality dental care experience.',
      videoUrl: '/assets/videos/firat_okur.mp4',
