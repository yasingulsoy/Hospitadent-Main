  ...
  return (
    <section name='services' className="py-8 md:py-20 bg-white scroll-pt-24 ">
      <div className="w-full max-w-none px-0 relative">
        ...
        {/* Modern Ok Butonları */}
        <button className="services-prev absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg border border-blue-100 hover:bg-blue-50 hover:scale-110 transition-all duration-300 w-12 h-12 rounded-full flex items-center justify-center text-blue-700 text-2xl group" aria-label="Geri">
        ...
        <button className="services-next absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg border border-blue-100 hover:bg-blue-50 hover:scale-110 transition-all duration-300 w-12 h-12 rounded-full flex items-center justify-center text-blue-700 text-2xl group" aria-label="İleri">
